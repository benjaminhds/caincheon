        ...
        <div class="secWrap">
            ...
            <section class="sec01 fin">
                ...
                <div class="secCont">
                    <!-- tabs -->
                    <ul class="tabs">
                    	<li <c:if test="${i_sCIdx == null}">class="on"</c:if>><a href="/normal_board_list.do?i_sBidx=${bd_content.B_IDX}">전체보기</a></li>
                    	<c:forEach items="${newsList}" var="list">
	                    	<li <c:if test="${i_sCIdx eq  list.c_idx}">class="on"</c:if>><a href="/normal_board_list.do?i_sBidx=${bd_content.B_IDX}&i_sCIdx=${list.c_idx}">${list.name}</a></li>
                    	</c:forEach>
                    </ul>
                    <!-- //tabs -->
