...
<!-- //facebook login -->
<ul class="snsLog">
    <li class="fb"><a href="javascript: myFacebookLogin()">FaceBook 로그인</a></li>
    <li class="ko" id="kakao-logged-group"><div id="kakao-login-btn"></div><div id="kakao-profile"></div></li>
    <li class="nv" id="naver_id_login"></li>
</ul>

<!-- //네이버아이디로로그인 버튼 노출 영역 -->
<%@ include file="/member/sns/inc_naver_login.jsp" %>
<script type="text/javascript" src="/member/sns/naverLogin_implicit-1.0.3.js" charset="utf-8"></script>
<script type="text/javascript" src="http://code.jquery.com/jquery-1.11.3.min.js"></script>
<script type="text/javascript">
  	var naver_id_login = new naver_id_login("<%=clientid_naver%>", "<%=callbackURL_naver_login%>");
...
<!-- //카카오로그인 버튼 노출 영역 -->
<%@ include file="/member/sns/inc_authkeys_kakao.jsp" %>
