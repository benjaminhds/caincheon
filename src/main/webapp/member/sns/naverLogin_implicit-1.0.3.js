 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		else if (this.button_width > 0 )
		{
			naver_id_login.innerHTML = "<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><font color=white>네이버 아이디로 로그인</font></a>"; 
			naver_id_login.style.width = this.button_width + "px"; 
			naver_id_login.style.height = this.button_height + "px"; 
			naver_id_login.style.backgroundColor = "#21bb03"; 
			naver_id_login_contents = naver_id_login.innerHTML;
			//naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='http://static.nid.naver.com/oauth/big_"+color+".PNG' border='0' title='네이버 아이디로 로그인' width='"+(this.button_width)+"px' height='"+this.button_height+"px'></a> ";
		}
