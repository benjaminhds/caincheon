            ...
            <section class="sec01 fin">
                ...
                <div class="secCont">
                            ...
                            <tfoot>
                                <tr>
                                    <td><!-- 
                                        ...
                                        <ul class="sns">
                                            <li><a href="javascript:goFacebook('/news/mov_view.do?b_idx=${b_idx}&bl_idx=${bl_idx}','인천교구')"><img src="/img/sub/_ico/ico_facebook.png" alt="페이스북"></a></li>
                                            <li><a href="javascript:goTweeter('/news/mov_view.do?b_idx=${b_idx}&bl_idx=${bl_idx}','인천교구')"><img src="/img/sub/_ico/ico_tweet.png" alt="트위터"></a></li>
                                            <li><a href="javascript:goKakao('/news/mov_view.do?b_idx=${b_idx}&bl_idx=${bl_idx}','인천교구')"><img src="/img/sub/_ico/ico_kakao.png" alt="카카오스토리"></a></li>
                                        </ul>
                                    </td>
                                </tr>
                            </tfoot>                          
                    ...
                    <ul class="btn btnLeft">
                        <li class="gray"><a href="javascript:viewMov('${movContents.B_IDX}','${movContents.before_p_idx}')">이전</a></li>
                        <li class="gray"><a href="javascript:viewMov('${movContents.B_IDX}','${movContents.next_p_idx}')">다음</a></li>
                    </ul>
                    <!-- //btnLeft -->
                    <!-- btn -->
                    <ul class="btn">
