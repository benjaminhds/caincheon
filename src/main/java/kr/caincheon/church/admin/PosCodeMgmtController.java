...
@Controller
public class PosCodeMgmtController extends CommonController
{
     ...
     */
    @RequestMapping(value = "/admin/org/pos_code_mgmt.do")
    public ModelAndView positionCodeList(HttpServletRequest request) throws Exception
    {
    	ModelAndView mv = new ModelAndView("/admin/code/pos_code_mgmt");
     ...
     * @throws CommonException
     */
    @RequestMapping(value = "/admin/org/pos_code_mgmt_cud.do")
