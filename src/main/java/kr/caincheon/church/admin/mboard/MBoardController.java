...
public class MBoardController extends CommonController
{
	...
	*/
	 ...
	 * @throws CommonException
	 */
	@RequestMapping(value = "/n/board/normal_board_iudboard.do")
	public @ResponseBody Map<String,Object> normal_board_iudboard(HttpServletRequest request) throws Exception
	{
		// request handling
		build(request);
		...
		try {
			...
			mBoardService.iudPostsMaster(_params);
