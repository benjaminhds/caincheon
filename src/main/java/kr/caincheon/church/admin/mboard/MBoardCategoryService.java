...
@Service("mBoardCategoryService")
public class MBoardCategoryService extends CommonService
{
    private final Logger L = Logger.getLogger(getClass());
    
    // 멀티게시판 조회
    @Resource(name="mBoardCategoryDAO")
    private MBoardCategoryDAO mBoardCategoryDAO;
	...
	public CommonDaoDTO listBoard(Map params) throws CommonException, Exception {
		...
		// board list
		CommonDaoDTO dto = mBoardCategoryDAO.selectMBoardCatetoryList(params);
