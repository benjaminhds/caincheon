 ...
 * @author benjamin
 */
@Repository("cdMBoardCategoryDAO")
public class CdMBoardCategoryDAO extends AbstractDAO {
	...
	public CommonDaoDTO selectMBoardCatetoryList(Map params) throws Exception {
		...
		// Query Combination
		try {
			Map rmap = selectPagingList("admin.mboardcategory.selectPagingMBoardCategory", params);
