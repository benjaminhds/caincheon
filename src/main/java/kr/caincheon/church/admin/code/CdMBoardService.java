...
@Service("cdMBoardService")
public class CdMBoardService extends CommonService
{
...
//    private BoardCategoryDao boardCategoryDao;
    ...
    // 멀티게시판 조회
    @Resource(name="cdMBoardDAO")
    private CdMBoardDAO cdMBoardDAO;
	...
	public CommonDaoDTO listBoard(Map params) throws CommonException, Exception {
		...
		// board list
		CommonDaoDTO dto = cdMBoardDAO.selectMboard(params);
