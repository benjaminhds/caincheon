...
function insertFormSend() {
	...
	frm.action = '/admin/org/pos_code_mgmt_cud.do';
	frm.mode.value = 'i';
	frm.submit();
    return false;
}
			...
			<div id="insCodeDiv">
				...
				<table class="table">
			  	...
			  	<tr>
			  		...
			  		<td>
			  			<label><input type="checkbox" name="i_use_yn" id="i_use_yn" style="width: 50" onclick="javascript: toggleUseyn()"/> 활성여부</label>&nbsp;
			...
			<!--  Search : begin //-->
			  <table class="table">
			  	...
			  	<tr>
			  		...
			  		<td><label for="q_word">옵션</label></td>
			  		<td>
			  			<label><input type="checkbox" name="u_use_yn" id="u_use_yn" style="width: 50" onclick="javascript: document.getElementById('p_use_yn').value=this.checked?'Y':'N'"/> 활성여부</label>&nbsp;
