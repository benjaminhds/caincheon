        ...
        <div class="secWrap">
            ...
            <section class="sec01 fin">
                ...
                <div class="secCont">
                    ...
                    <ul class="tabs">
						    <c:if test="${code eq '4'}">
						        	<li class="on"><a href="/intro/ordo_list.do?code=4&pageNo=1">전체보기</a></li>
									<li><a href="/intro/ordo_list.do?code=41&pageNo=1">남자</a></li>
                        			<li><a href="/intro/ordo_list.do?code=42&pageNo=1">여자</a></li>
						    </c:if>
						    <c:if test="${code eq '41'}">
						        	<li><a href="/intro/ordo_list.do?code=4&pageNo=1">전체보기</a></li>
									<li class="on"><a href="/intro/ordo_list.do?code=41&pageNo=1">남자</a></li>
                        			<li><a href="/intro/ordo_list.do?code=42&pageNo=1">여자</a></li>
						    </c:if>
						    <c:if test="${code eq '42'}">
						        	<li><a href="/intro/ordo_list.do?code=4&pageNo=1">전체보기</a></li>
									<li><a href="/intro/ordo_list.do?code=41&pageNo=1">남자</a></li>
                        			<li class="on"><a href="/intro/ordo_list.do?code=42&pageNo=1">여자</a></li>
						    </c:if>
						    <c:if test="${fn:substring(code,0,1) ne '4' }">
						        	<li><a href="/intro/ordo_list.do?code=4&pageNo=1">전체보기</a></li>
									<li><a href="/intro/ordo_list.do?code=41&pageNo=1">남자</a></li>
                        			<li><a href="/intro/ordo_list.do?code=42&pageNo=1">여자</a></li>
						    </c:if>
